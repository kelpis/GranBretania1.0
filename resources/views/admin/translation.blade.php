<x-app-layout>
    ...
    <div class="py-8 max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="rounded-2xl shadow-xl overflow-hidden border border-beige bg-beige2 p-6">

            {{-- ========================= --}}
            {{-- CALCULADORA TRADUCCIÓN --}}
            {{-- ========================= --}}
            <div id="translation-calculator" class="mb-8 rounded-2xl border border-azul/20 bg-azul text-white shadow p-6">
