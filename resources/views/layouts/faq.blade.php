        ...
        <section id="faq" class="bg-beige2 py-16 dark:bg-slate-950">
            ...
            <div class="container mx-auto px-4 max-w-3xl">
                ...
                <div class="space-y-4">
                    ...
                    <details class="bg-white rounded-lg shadow p-4 dark:bg-slate-900">
                        <summary class="font-semibold text-azul cursor-pointer dark:text-beige2">¿Qué niveles ofrecéis?
                        </summary>
                        <p class="mt-2 text-gray-700 dark:text-slate-100">
                    ...
                    <details class="bg-white rounded-lg shadow p-4 dark:bg-slate-900">
                        ...
                        <p class="mt-2 text-gray-700 dark:text-slate-100">
                            Actualmente imparto clases individuales, para ofrecer un aprendizaje adaptado a tu nivel, ritmo
                            y objetivos.
                        </p>
                    </details>
                    ...
                    <details class="bg-white rounded-lg shadow p-4 dark:bg-slate-900">
                        ...
                        <p class="mt-2 text-gray-700 dark:text-slate-100">
                            Puedes adjuntar archivos en <strong>PDF, DOCX, ODT o TXT</strong> desde el formulario de
                            traducción.
                        </p>
                    </details>
                    ...
                    <details class="bg-white rounded-lg shadow p-4 dark:bg-slate-900">
                        ...
                        <p class="mt-2 text-gray-700 dark:text-slate-100">
                            Trabajo con textos jurídicos, médicos, académicos, audiovisuales, y traducción general y
                            profesional.
                        </p>
                    </details>
                    ...
                    <details class="bg-white rounded-lg shadow p-4 dark:bg-slate-900">
                        ...
                        <p class="mt-2 text-gray-700 dark:text-slate-100">
                            Sí. Ofrezco interpretación consecutiva y simultánea por videollamada para reuniones, entrevistas
                            y eventos online.
                        </p>
                    </details>
        ...
        <section id="cta-final" class="relative py-24 dark:bg-slate-900">
            ...
            <div class="relative container mx-auto px-6 text-left text-white">
                ...
                <div class="flex flex-wrap justify-left gap-4">
                    ...
                    <a href="{{ route('traducciones') }}" class="btn-three">
                        Traducciones
                    </a>
