    ...
    <div class="wrapper">
        ...
        <div class="header"
            ...
            <div style="max-width:560px; margin:0 auto;">
                <h1 style="margin:0; font-size:22px; font-weight:700; color:#ffffff; text-align:center;">
                    {{ config('app.name') }}
                </h1>
                <h2 style="margin:6px 0 0 0; font-size:13px; font-weight:600; color:#D51C3B; text-align:center;">
                    Enseñanza de inglés y traducciones</h2>
            </div>
        </div>
                ...
                @isset($actionText)
                    <div style="margin: 30px 0;">
                        <a href="{{ $actionUrl }}" class="button"
                            style="display:inline-block;background:#D51C3B;padding:14px 24px;border-radius:8px;text-decoration:none;font-weight:700;font-size:16px;color:#fff;">{{ $actionText }}</a>
                    </div>
                @endisset
            ...
            ">
                    <div style="max-width:560px; margin:0 auto; text-align:center;">
                        ...
                        <div style="opacity:0.9; font-size:12px;">
                            ...
                            ·
                            <a href="{{ url('/profile') }}" style="color:inherit; text-decoration:underline;">
                                Gestionar notificaciones
                            </a>
                        </div>
                        <div style="margin-top:8px; font-size:11px; opacity:0.8;">
                            Si no reconoces esta actividad, ponte en contacto con nosotros.
                        </div>
                    </div>
                </div>
        @endisset
