...
@section('content')
  <section class="container mx-auto px-4 py-10 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="grid lg:grid-cols-4 gap-10">
      ...
      <aside class="lg:col-span-1">
        <div class="bg-beige2 rounded-2xl p-4 text-sm sticky top-24
          ...
          <ul class="space-y-2">
            <li><a href="#responsable" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">1. Responsable del tratamiento</a></li>
            <li><a href="#datos" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">2. Datos que recopilamos</a></li>
            <li><a href="#finalidad" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">3. Finalidad del tratamiento</a></li>
            <li><a href="#legitimacion" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">4. Legitimación</a></li>
            <li><a href="#conservacion" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">5. Plazos de conservación</a></li>
            <li><a href="#destinatarios" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">6. Destinatarios</a></li>
            <li><a href="#derechos" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">7. Tus derechos</a></li>
            <li><a href="#seguridad" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">8. Seguridad de la información</a></li>
            <li><a href="#cookies" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">9. Cookies</a></li>
            <li><a href="#contacto" class="text-gray-700 hover:text-azul dark:text-slate-100 dark:hover:text-beige2">10. Contacto</a></li>
          </ul>
        </div>
      </aside>
      ...
      <div class="lg:col-span-3 space-y-8 text-sm md:text-base leading-relaxed text-gray-800 dark:text-slate-100">
        ...
        <section id="datos" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">2. Datos que recopilamos</h2>
          <p class="mb-2">
        ...
        <section id="finalidad" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">3. Finalidad del tratamiento</h2>
          <p class="mb-2">Utilizamos tus datos para:</p>
          <ul class="list-disc ml-5 space-y-1">
            <li>Gestionar tus solicitudes de <strong>clases de inglés online</strong>.</li>
            <li>Elaborar y enviarte presupuestos de <strong>traducción</strong> e <strong>interpretación online</strong>.</li>
        ...
        {{-- 4. LEGITIMACIÓN --}}
        <section id="legitimacion" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">4. Legitimación</h2>
          <p class="mb-2">La base legal para el tratamiento de tus datos es:</p>
          <ul class="list-disc ml-5 space-y-1">
            <li>
              <strong>Ejecución de un contrato</strong> o aplicación de medidas precontractuales
              (cuando solicitas clases, traducciones o interpretación).
            </li>
            <li>
              <strong>Consentimiento</strong> (cuando marcas la casilla de aceptación de la política de privacidad en
              los formularios).
            </li>
            <li>
              <strong>Obligación legal</strong> (obligaciones fiscales o contables asociadas a los servicios prestados).
            </li>
          </ul>
        </section>

        {{-- 5. CONSERVACIÓN --}}
        <section id="conservacion" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">5. Plazos de conservación</h2>
          <p>
        ...
        {{-- 6. DESTINATARIOS --}}
        <section id="destinatarios" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">6. Destinatarios de los datos</h2>
          <p class="mb-2">
        ...
        {{-- 7. DERECHOS --}}
        <section id="derechos" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">7. Tus derechos</h2>
          <p class="mb-2">
        ...
        {{-- 8. SEGURIDAD --}}
        <section id="seguridad" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">8. Seguridad de la información</h2>
          <p>
        ...
        {{-- 9. COOKIES --}}
        <section id="cookies" class="bg-white rounded-2xl shadow p-6 dark:bg-slate-900">
          <h2 class="text-azul font-semibold text-lg mb-3 dark:text-beige2">9. Cookies</h2>
          <p>
            ...
            <a href="{{ route('cookies.policy') }}" class="text-azul underline dark:text-beige2 dark:hover:text-rojo">
              Política de cookies
            </a>.
          </p>
        </section>
