...
@section('content')
    <section id="condiciones-servicio" class="bg-white rounded-2xl shadow p-6
        ...
        <h2 class="text-azul font-semibold text-xl mb-4 dark:text-beige2">Condiciones del servicio</h2>

        {{-- 1. Objeto --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">1. Objeto</h3>
        ...
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">2. Cumplimiento de la LSSI-CE</h3>
        <p class="text-gray-800 dark:text-slate-100">
        ...
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">3. Pagos y pasarela de pago segura</h3>
        <p class="text-gray-800 mb-2 dark:text-slate-100">
        ...
        <p class="text-gray-800 text-sm dark:text-slate-300">
            Más información en:
            <a href="https://stripe.com/es/privacy" target="_blank"
                class="text-azul underline dark:text-beige2 dark:hover:text-rojo">
                Política de privacidad de Stripe
            </a>.
        </p>

        {{-- 4. Condiciones de reserva (clases de inglés) --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">
            4. Condiciones de reserva (clases de inglés)
        </h3>
        <ul class="list-disc ml-5 space-y-2 text-gray-800 dark:text-slate-100">
        ...
        {{-- Clases de prueba --}}
        <h4 class="text-azul font-semibold text-base mt-4 mb-1 dark:text-beige2">
            Clases de prueba
        </h4>
        <ul class="list-disc ml-5 space-y-2 text-gray-800 dark:text-slate-100">
        ...
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">5. Condiciones del servicio de traducción
        </h3>
        <ul class="list-disc ml-5 space-y-2 text-gray-800 dark:text-slate-100">
        ...
        {{-- 6. Interpretación --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">6. Condiciones del servicio de interpretación
        </h3>
        <ul class="list-disc ml-5 space-y-2 text-gray-800 dark:text-slate-100">
        ...
        {{-- 7. Reembolsos --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">7. Política de reembolsos</h3>
        <p class="text-gray-800 dark:text-slate-100">
        ...
        {{-- 8. Responsabilidad --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">8. Limitación de responsabilidad</h3>
        <p class="text-gray-800 dark:text-slate-100">
        ...
        {{-- 9. Aceptación --}}
        <h3 class="text-azul font-semibold text-lg mt-6 mb-2 dark:text-beige2">9. Aceptación de las condiciones</h3>
        <p class="text-gray-800 dark:text-slate-100">
